...
# take all collections and its names and put them in a list of tuples

halls = [(collection.name, collection) for collection in bpy.data.collections]
