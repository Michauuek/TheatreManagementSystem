...
class ActorRepository {
    ...
    suspend fun getById(id: Int): Actor? = DatabaseFactory.dbQuery{
        ActorTable
    ...
    suspend fun getAll(): List<Actor> = DatabaseFactory.dbQuery{
        ActorTable
            .selectAll()
    ...
    suspend fun getByPerformanceId(id: Int): List<ActorCastResponse> = DatabaseFactory.dbQuery{
